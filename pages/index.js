...
export default function Home() {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col justify-center items-center">
      <button
        className="p-3 px-6 rounded bg-blue-500 text-white text-xl ease-in duration-150 hover:scale-105"
      ...
      {toggleMultiStepForm == true && (
        <div className="absolute bg-white w-full max-w-[550px] mx-auto justify-center items-center border border-gray-100 rounded drop-shadow-2xl  drop-shadow-[0_5px_50px_rgba(0,0,0,0.2)]">
          <div className="flex flex-col p-4 justify-center items-center">
            ...
            <span
              className="absolute top-3 right-3 cursor-pointer fill-gray-500 scale-115 ease-in duration-150 hover:scale-125"
              onClick={() => {
                setPage(0);
